    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
                ...
                <form action="tambah_registrasi.php" method="POST" enctype="multipart/form-data">

                    <div class="col-md">
                        <div class="row justify-content-center">
                        </div>
                        <div class="row" style="margin-bottom: 10px;">
                            <label for="inputnama" class="col-sm-4">Nama
                                Lengkap</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="" name="nama_lengkap" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md">
                    ...
                    <div class="col-md">
                        <div class="row" style="margin-bottom: 10px;">
                            <label for="inputUsername" class="col-sm-4">NIM</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="" name="nim" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md">
                        <div class="row" style="margin-bottom: 10px;">
                            <label for="inputTelp" class="col-sm-4">No Telp</label>
                            <div class="col-sm-7">
