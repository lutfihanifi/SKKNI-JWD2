    ...
    <form action="index.php" method="post">
        <table width="700px">
            <tr>
                ...
                <td>:</td>
                <td width="80%"><input type="text" name="maskapai" class="inputtext" placeholder="Nama Maskapai"
                        required=""></td> <!-- Input nama Maskapai -->
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td><input type="number" name="harga" class="inputtext" placeholder="Harga Tiket" required=""></td>
                <!-- Input Harga Tiket -->
            </tr>
            <tr>
                <td colspan="3" style="text-align: center;"><input type="submit" value="Submit" name="submit"></td>
                <!-- Submit Form -->
            </tr>
        </table>
    </form> <br>
